...
cuda_visible_devices=$cuda_visible_devices python src/run_bert_gt.py \
  ...
  --data_dir=datasets/ChemProt/processed/ \
  --output_dir=out_chemprot_model/

python src/run_eval.py --task=chemprot --output_path=out_chemprot_model/test_results.tsv --answer_path=datasets/ChemProt/processed/test.tsv