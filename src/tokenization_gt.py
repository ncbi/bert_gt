...
def update_index(text, tokenized_text, all_neighbors):
...
def load_vocab(vocab_file, entity_type_list=None):
  """Loads a vocabulary file into a dictionary."""
  vocab = collections.OrderedDict()
  index = 0
  non_selected_entity_type_list = list(entity_type_list)
...
class FullTokenizer(object):
  ...
  def __init__(self, vocab_file, entity_type_list=None, do_lower_case=True):
    self.vocab = load_vocab(vocab_file, entity_type_list)
